...
two-pass macro-processor. The output of Pass-I (MNT, MDT and intermediate
code file without any macro definitions) should be input for Pass-II.
*/
...
public class MacroProcessor {
	...
	public static void main(String[] args) throws IOException
	{
		...
		pnt.close();
		kpdt.close();
		System.out.println("Macro Pass1 & Pass 2 Processing Completed.");
	}
